  ...
  private Issue[] getSeedData() {
    return new Issue[] {
      new Issue(
          1,
          1,
          "Burn down chart for a Sprint - showing progress against plan",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          2,
          1,
          "Ability to add a new issue (with corresponding add onto GitLab)",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          3,
          1,
          "Ad-hoc filtering of issues table",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          4,
          1,
          "Show a planning view of issues - all issues for a sprint with no story points set",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          5,
          1,
          "List workspaces I have access to",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          1,
          2,
          "Rename a Sprint causing the milestone to be renamed on GitLab",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          2,
          2,
          "Delete a Sprint causing a milestone to be removed on GitLab",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          3,
          2,
          "Create a new Sprint, causing a milestone to be created on GitLab",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          4,
          2,
          "Define a concept of 'Sprint' mapped from GitLab milestone",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          5,
          2,
          "Define a concept of 'Status' mapped from GitLab 'labels'",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          1,
          3,
          "Define a concept of 'Story Points' mapped from GitLab 'labels'",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          2,
          3,
          "Associate GitLab credentials with workspaces/projects",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          3,
          3,
          "Grant access rights of workspaces to particular users",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          5,
          3,
          "Associate the application with a specific GitLab instance",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          1,
          4,
          "Edit a workspaces' list of GitLab projects",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          2,
          4,
          "Edit a workspace's name or description",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          4,
          4,
          "Associate one or more GitLab projects with a workspace",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          5,
          4,
          "Define a new 'Workspace' with a name, description",
          "",
          new User(),
          new User(),
          "opened",
      ...
      new Issue(
          1,
          5,
          "Sprint Metrics - expected story points vs actual (worked out from calculating time spent on the card)",
          "",
          new User(),
          new User(),
          "closed",
      ...
      new Issue(
          2,
          5,
          "Workspace Metrics view - showing key metrics for the workspace - total projects, average velocity etc",
          "",
          new User(),
          new User(),
          "closed",
      ...
      new Issue(
          3,
          5,
          "Sprint Metrics view - showing by sprint, metrics showing the total issues completed, issues planned but not completed, and total story points",
          "",
          new User(),
          new User(),
          "opened",
